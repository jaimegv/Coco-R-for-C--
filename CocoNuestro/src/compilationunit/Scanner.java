...
public class Scanner {
	...
	static {
		...
		literals.put("boolean", new Integer(4));
		literals.put("bool", new Integer(5));
		literals.put("char", new Integer(6));
		literals.put("class", new Integer(7));
		literals.put("false", new Integer(8));
		literals.put("int", new Integer(9));
		literals.put("new", new Integer(10));
		literals.put("short", new Integer(11));
		literals.put("static", new Integer(12));
		literals.put("true", new Integer(13));
		literals.put("void", new Integer(14));
		literals.put("public", new Integer(15));
		literals.put("private", new Integer(16));
		literals.put("return", new Integer(18));
		literals.put("cout", new Integer(19));
		literals.put("cin", new Integer(20));
		literals.put("if", new Integer(23));
		literals.put("else", new Integer(24));
		literals.put("main", new Integer(25));
		...
		loop: for (;;) {
			switch (state) {
				...
				case 3:
					{t.kind = 2; break loop;}
				case 4:
					if (ch <= '!' || ch >= '#' && ch <= 65535) {AddCh(); state = 4; break;}
