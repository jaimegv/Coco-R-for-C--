...
public class Scanner {
	...
	static {
		...
		literals.put("char", new Integer(5));
		literals.put("class", new Integer(6));
		literals.put("false", new Integer(7));
		literals.put("int", new Integer(8));
		literals.put("new", new Integer(9));
		literals.put("short", new Integer(10));
		literals.put("static", new Integer(11));
		literals.put("true", new Integer(12));
		literals.put("void", new Integer(13));
		literals.put("public", new Integer(14));
		literals.put("private", new Integer(15));
		literals.put("return", new Integer(17));
		literals.put("cout", new Integer(18));
		literals.put("cin", new Integer(19));
		literals.put("if", new Integer(22));
		literals.put("else", new Integer(23));
		literals.put("main", new Integer(24));
