...
public class GCF {
    ...
    public GCF(LinkedList<tupla_Tercetos> colaTercetos, LinkedList<tupla_Tercetos> colaMain, Tablas tabla, String fichero) {
        ...
        //Si el analisis sintactico ha validado el codigo, esto no deberia producir ninguna excepcion.
        tabla.AbrirAmbito(tabla.GetSimboloRecur("main").GetAmbitoAsociado());
        ...
        try {
            ...
            desp_total = tabla.GetAmbitoActual().GetDesplazamiento();
    ...
    public void traducir(Tablas tabla){
        ...
        if ( operacion.compareTo("+") == 0 ){
            ...
            try {
                ...
                simbolo3 = tabla.GetSimboloActual(op3); //buscamos sólo en la actual ya q es un temporal
                desp_resultado = simbolo3.Actualiza_Tamano();
                ...
                if (!es_objeto1 && !es_objeto2 && !es_vector1 && !es_vector2){
                    ...
                    simbolo1 = tabla.GetSimboloActual(op1); //buscamos en la tabla actual y en la del padre
                    simbolo2 = tabla.GetSimboloActual(op2); //buscamos en la actual y padre
                    if (simbolo1 == null){
                        //si no se ha encontrado el operador en la tabla de simbolos
                        //es que está utilizando las variables del padre
                        simbolo1 = tabla.GetSimboloRecur(op1);
                        desp_arg1 = simbolo1.Actualiza_Tamano();
                        esta_en_padre1 = true;
                    }
                    else {
                          desp_arg1 = simbolo1.Actualiza_Tamano();
                    ...
                    if (simbolo2 == null){
                        //si no se ha encontrado el operador en la tabla de simbolos
                        //es que está utilizando las variables del padre
                        simbolo2 = tabla.GetSimboloRecur(op2);
                        desp_arg2 = simbolo2.Actualiza_Tamano();
                        esta_en_padre2 = true;
                    }
                    else {
                            desp_arg2 = simbolo2.Actualiza_Tamano();
                    ...
                    if (es_vector1 && es_vector2){
                        ...
                        simbolo1 = tabla.GetSimboloActual(ident);

                        if (simbolo1 == null){
                            simbolo1 = tabla.GetSimboloRecur(ident);
                            esta_en_padre1 = true;
                            desp_vector1 = simbolo1.Actualiza_Tamano();
                        }
                        else {
                            desp_vector1 = simbolo1.Actualiza_Tamano();
                        }
                        ...
                        simbolo1 = tabla.GetSimboloActual(indice);
                        desp_indice1 = simbolo1.Actualiza_Tamano(); //aqui tenemos el desplazamiento del temporal
                        ...
                        if (simbolo1 == null){
                            simbolo1 = tabla.GetSimboloRecur(ident);
                            esta_en_padre2 = true;
                            desp_vector2 = simbolo1.Actualiza_Tamano();
                        }
                        else {
                            desp_vector2 = simbolo1.Actualiza_Tamano();
                        }
                        ...
                        //buscamos el desplazamiento del temporal que contiene el indice del vector
                        simbolo1 = tabla.GetSimboloActual(indice);
                        desp_indice2 = simbolo1.Actualiza_Tamano(); //aqui tenemos el desplazamiento del temporal
                    ...
                    if (es_vector1 && !es_vector2){
                        ...
                        //ahora el operador 2
                        simbolo1 = tabla.GetSimboloActual(op2); //buscamos en la tabla actual y en la del padre
                        if (simbolo1 == null){
                            //si no se ha encontrado el operador en la tabla de simbolos
                            //es que está utilizando las variables del padre
                            simbolo1 = tabla.GetSimboloRecur(op2);
                            desp_arg2 = simbolo1.Actualiza_Tamano();
                            esta_en_padre2 = true;
                        }
                        else {
                            desp_arg2 = simbolo1.Actualiza_Tamano();
            ...
            try {
                ...
                // El elemento de la izquierda es un vector
                    ...
                    // el elemento de la derecha es un ident
                        ...
                        simbolo2 = tabla.GetSimboloActual(op2);
                        if (simbolo2 == null){
                            //si no se ha encontrado el operador en la tabla de simbolos
                            //es que está utilizando las variables del padre
                            simbolo2 = tabla.GetSimboloRecur(op2);
                ...
                //el elemento de la izquierda es un ident
                    ...
                    //hallamos los desplazamientos del argumento y del resultado
                    simbolo1 = tabla.GetSimboloActual(op1); //cogemos el operador de la izquierda de la asignacion
                    if (simbolo1 == null){
                    //si no se ha encontrado el operador en la tabla de simbolos
                    //es que está utilizando las variables del padre
                        simbolo1 = tabla.GetSimboloRecur(op1);
        ...
        // x = 1;
            ...
            try {
                ...
                simbolo1 = tabla.GetSimboloActual(op1);
                desp_arg1 = simbolo1.Actualiza_Tamano(); //cogemos el desplazamiento del temporal
         ...
         * deja hueco para las variables globales, guarda los parametros*/
            ...
            try {
            	...
            	tabla.AbrirAmbito(tabla.GetSimboloActual(op1).GetAmbitoAsociado());
//OJOOOOOOOOOOO //tabla.t_actual = tabla.BuscarEnHijos(op1);
                bw.write(op1 + ":\n"); //escribimos el nombre de la etiqueta
                bw.write("MOVE .SP,.IX\n");  //copiamos el puntero de pila al marco de pila para q apunte a los parametros
                desp_total = tabla.GetAmbitoActual().GetDesplazamiento(); //cogemos el desp total de la tabla
        ...
        //mete en la pila el parametro indicado en "ident"
            ...
            try {
                ...
                simbolo1 = tabla.GetSimboloActual(op3);
                if (simbolo1 == null){
                    simbolo1 = tabla.GetSimboloRecur(op3);
                    desp_arg1 = simbolo1.Actualiza_Tamano();
                    bw.write("MOVE #1[.IX], .IY\n");
        ...
        //realiza la negacion del operador ident y mete el resultado en el temporal
            ...
            try {
                ...
                if (simbolo1 == null){
                    ...
                    desp_arg1 = simbolo1.Actualiza_Tamano();  //desplazamiento de ident
                    
                simbolo2 = tabla.GetSimboloActual(op2);
                desp_arg2 = simbolo2.Actualiza_Tamano();  //desplazamiento del temporal
        ...
        // Emite (<, op1, op2, temp)
            ...
            try {
                //hallamos los desplazamientos de los argumentos y del resultado
                simbolo1 = tabla.GetSimboloActual(op1); //buscamos en la tabla actual
                simbolo2 = tabla.GetSimboloActual(op2); //buscamos en la actual
                simbolo3 = tabla.GetSimboloActual(op3); //buscamos sólo en la actual ya q es un temporal
                if (simbolo1 == null){
        ...
        // Emite (IF,ident,etiqueta)
            ...
            simbolo1 = tabla.GetSimboloActual(op1); //buscamos primero en la actual
            if (simbolo1 == null){
                    //si no se ha encontrado el operador en la tabla de simbolos actual
                    //es que está utilizando las variables del padre
                    simbolo1 = tabla.GetSimboloRecur(op1);
    ...
    public void Buscar_En_ColaTercetos (LinkedList<tupla_Tercetos> colaTercetos, String metodo, Tablas tabla){
